...
function handlechange(value) {
 ...
 setcategory("")
  ...
  return (
    ...
    className="w-[300px] rounded-4xl text-white italic pt-2 pb-[100px] overflow-y-auto fixed left-4 top-5 bottom-6 z-10  shadow-xl bg-green-500 px-3  border border-gray-200">
